...
class DocumentController extends Controller
{
    ...
    public function show($tab, $id)
    {
        ...
        return view('admin.records.show', compact('tab', 'id', 'document'));
    }
    ...
    public function create($tab)
    {
        ...
        return view('admin.records.create', compact('tab'));
    }
    ...
    public function edit($tab, $id)
    {
        ...
        return view('admin.records.edit', compact('tab', 'id', 'document'));
    }
