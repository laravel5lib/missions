...
class DonationRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'card.card_id'   => 'required_without:card.number',
            'card.cardholder' => 'required_without:card.card_id|string',
            'card.number'    => 'required_without:card.card_id|string',
            'card.exp_month' => 'required_with:string',
            'card.exp_year'  => 'required_with:number|digits:4',
            'card.cvc'       => 'required_with:number|digits_between:3,4',
        ];
    }
}
