...
class MedicalReleaseTransformer extends TransformerAbstract
{
    ...
    public function transform(MedicalRelease $release)
    {
        $array = [
            ...
            'name'              => $release->name,
            'pregnant'          => (bool) $release->pregnant,
            'height'            => [ 'standard' => $release->height_standard, 'metric' => $release->height ],
            'weight'            => [ 'standard' => $release->weight_standard, 'metric' => $release->weight ],
