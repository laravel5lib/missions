...
class CreateBouncerTables extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::table(Models::table('user_roles'), function (Blueprint $table) {
        ...
        Schema::table(Models::table('user_abilities'), function (Blueprint $table) {
        ...
        Schema::table(Models::table('role_abilities'), function (Blueprint $table) {
            $table->foreign('ability_id')->references('id')->on(Models::table('abilities'))
                ->onUpdate('cascade')->onDelete('cascade');
