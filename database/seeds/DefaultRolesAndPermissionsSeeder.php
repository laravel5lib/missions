...
class DefaultRolesAndPermissionsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $role = Role::create(['name' => 'staff_general']);
        $role->givePermissionTo([
            'access_backend',
            'edit_trips',
            'add_squads',
        ...
        $role = Role::create(['name' => 'moderator_medical']);
        $role->givePermissionTo([
            'access_backend',
            'view_reservations',
        ...
        $role = Role::create(['name' => 'moderator_travel_documents']);
        $role->givePermissionTo([
            'access_backend',
            'view_reservations',
            'view_passports',
        ...
        $role = Role::create(['name' => 'moderator_general']);
        $role->givePermissionTo([
            'access_backend',
            'view_reservations',
            'view_credentials',
        ...
        $role = Role::create(['name' => 'projects_manager']);
        $role->givePermissionTo([
            'access_backend',
            'view_causes',
            'view_projects',
        ...
        $role = Role::create(['name' => 'team_facilitator']);
    }
}
