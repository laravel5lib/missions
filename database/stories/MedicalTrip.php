...
class MedicalTrip extends BaseTrip
{
    /**
    ...
    {
        $trip = factory(Trip::class, 'medical')->create($params);
    ...
    protected function add_trip_requirements($trip)
    {
        $requirements = collect([
            ...
            factory(Requirement::class, 'medical-credentials')->make(['requester_id' => $trip->id]),
        ])->toArray();
