<template>
    <ajax-form method="put" :action="`campaigns/${campaignId}/flights/passengers`" :initial="itinerary" :horizontal="true" ref="ajax" @form:success="resetAndCloseForm">
        <template slot-scope="{ form }">
            <div class="alert alert-warning">Modifying itinerary for <strong>{{ passengers.length }}</strong> selected passengers.</div>
