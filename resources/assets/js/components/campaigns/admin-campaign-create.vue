			...
			<div class="form-group" :class="{ 'has-error': checkForError('country') }"> 
				...
				<div class="col-sm-10"> 
					<select name="country" id="country" class="form-control" v-model="country"
							v-validate:country="{ required: true }" required> 
			...
			<div class="form-group" :class="{ 'has-error': checkForError('description') }"> 
				...
				<div class="col-sm-10"> 
					<textarea name="short_desc" id="description" rows="2" v-model="description"  
							  ...
							  maxlength="120" minlength="1"></textarea> 
				</div>
				 
			</div>
			   
			<div class="form-group"> 
				<div class="col-sm-offset-2 col-sm-10">  <a href="/admin/campaigns" class="btn btn-default">Cancel</a> 
...
<script>     export default{
	...
	data(){
		return {name: null, country: null, country_code: null, description: null, attemptSubmit: false}
	},
	computed: {
		country_code(){
			return [this.country];
