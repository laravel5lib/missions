			...
			<form class="form-horizontal" role="form" v-if="currentState==='create'">
				...
				<div class="form-group">
					<div class="col-xs-10  col-xs-offset-1">
						...
						<input type="text" class="form-control" v-model="newUser.name" placeholder="John Doe" required
							   maxlength="100"/>
					</div><!-- end col -->
				</div><!-- end form-group -->
				<div class="form-group">
					<div class="col-xs-10  col-xs-offset-1">
						<label class="control-label">E-Mail Address</label>
						<input type="email" class="form-control" v-model="newUser.email" placeholder="example@gmail.com"
							   required/>
					</div><!-- end col -->
				</div><!-- end form-group -->
				<div class="form-group">
		...
		watch: {
			'currentState': function (val, oldVal) {
				if (val === 'create') {
					...
					tz = tz.indexOf(0) == 4
							? tz.slice(0, 4) +  tz.slice(5, 6) + ':' + tz.slice(6, 8)
							: tz.slice(0, 6) + ':' + tz.slice(6, 8);
