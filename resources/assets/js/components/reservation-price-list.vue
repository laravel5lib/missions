<template>
<fetch-json :url="'/reservations/' + reservationId+ '/prices'" ref="priceList">
        ...
        <div class="list-group-item" v-for="price in prices" :key="price.id" v-else>
            <div class="row">
                ...
                <div class="col-sm-4 col-xs-6 text-right">
                    <a class="btn btn-xs btn-default-hollow" :href="`/admin/reservations/${reservationId}/prices/${price.id}`">Manage</a>
                    <!-- <div style="padding: 0;">
...
export default {
    ...
    methods: {
        ...
        destroy(priceId) {
            swal('WARNING!', 'This action will remove this price. This action cannot be undone!', 'warning', {
                ...
                if (value) {
                    this.$http.delete('/reservations/' + this.reservationId + '/prices/' + priceId)
                        .then((response) => {
