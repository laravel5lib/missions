<template>
    <div class="list-group">
        <data-list :url="'reservations/' + reservationId + '/costs'">
            <template slot="empty">
...
export default {
    ...
    methods: {
        ...
        destroy(costId) {
            swal('WARNING!', 'This action will remove this cost from the reservation. This action cannot be undone!', 'warning', {
                ...
                if (value) {
                    this.$http.delete('/reservations/' + this.reservationId + '/costs/' + costId)
                        .then((response) => {
                            console.log('deleted');
