	    ...
	    <div class="col-sm-12">
	        <div class="panel panel-default">
	            <div class="panel-heading">
	                <h6><a data-toggle="collapse" href="#collapseHints" aria-expanded="true" aria-controls="collapseHints">Rooming Tutorial <span class="pull-right"><i class="fa" :class="{ 'fa-chevron-up': toggleHintsCollapse, 'fa-chevron-down': !toggleHintsCollapse}"></i></span></a></h6>
