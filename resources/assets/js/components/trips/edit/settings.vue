		...
		<div class="col-sm-12">
				...
				<form id="TripSettings" class="form-horizontal" novalidate>
					...
					<div class="form-group" :class="{ 'has-error': errors.has('closed') }">
						...
						<div class="col-sm-10">
							<date-picker input-sm v-model="closed_at" :view-format="['YYYY-MM-DD HH:mm:ss']"></date-picker>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<date-picker input-sm v-model="published_at" :view-format="['YYYY-MM-DD HH:mm:ss']"></date-picker>
