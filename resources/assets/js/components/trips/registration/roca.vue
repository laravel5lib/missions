<template>
	<div class="row">
		<div class="col-sm-12">
			<p class="small">MISSIONS.ME TEAM CULTURE</p>
			<p class="small">AS A MISSIONS.ME TEAM MEMBER, I PROMISE TO DO MY BEST TO CONTRIBUTE TO THE FOLLOWING TEAM CULTURE POINTS WHILE ON THIS TRIP.</p>
			...
			<p class="small">BREAKING ANY OF THE FOLLOWING RULES ARE GROUNDS FOR IMMEDIATE DISMISSAL FROM THIS MISSIONS.ME TRIP:</p>
			<ol>
			...
			<p class="small">BREAKING ANY OF THE FOLLOWING RULES ARE GROUNDS FOR IMMEDIATE DISCIPLINARY ACTION AND POSSIBLE DISMISSAL FROM THIS MISSIONS.ME TRIP:</p>
			<ol>
			...
			<p class="small">As a participant of a Missions.Me trip, I have read and fully understand the rules and regulations above. I also understand that I must comply with all Missions.Me rules and regulations in order to make my missions experience the best it can be. If I choose not to comply with these rules, I understand that I am subject to the consequences and even dismissal from the mission field AT MY OWN EXPENSE.</p>
		</div>
		<div class="col-sm-12">
			<hr class="divider">
			<div class="checkbox">
