                ...
                <form>
                    ...
                    <div class="form-group">
                        <label for="newStoryContent">Content
                            <button class="btn btn-primary btn-xs" type="button" @click="newMarkedContentToggle = !newMarkedContentToggle">
                    ...
                    <form>
                        ...
                        <div class="form-group">
                            <label for="selectedStoryContent">Content
                                <button class="btn btn-primary btn-xs" type="button" data-toggle="collapse" data-target="#markdownPrev{{$index}}"
                            ...
                            <textarea v-show="!editMarkedContentToggle" class="form-control" id="selectedStoryContent" v-model="selectedStory.content" minlength="1"></textarea>
