...
RootInstance.template = '<div><transports-details-passengers v-ref:test-component campaign-id="5830c58b-a183-49ec-a61e-a3c748b33c28" :transport="$root.transport"></transports-details-passengers></div>';
RootInstance.components = {'transports-details-passengers': require('../../../../components/admin/transports-details-passengers.vue')};
...
test('passengers populated', t => {
    t.not(AdminTransportsDetailsItineary.passengers, []);
});