    ...
    <div class="row">
      ...
      <div class="col-sm-3 col-sm-offset-0 col-xs-10 col-xs-offset-1">
        ...
        <ul class="list-inline">
          ...
          <li><a href="http://twitter.com/missionsme"><i class="fa fa-twitter"></i></a></li>
          <li><a href="http://instagram.com/missionsme"><i class="fa fa-instagram"></i></a></li>
        </ul>
      </div><!-- end col -->
      <div class="col-sm-3 col-sm-offset-0 col-xs-10 col-xs-offset-1">
        <hr class="divider">
        ...
        <ul class="list-unstyled">
          <address>
            145 S. Livernois Rd.<br>Suite 308<br>Rochester Hills, MI 48307
          </address>
        </ul>
      </div><!-- end col -->
      <div class="col-sm-3 col-sm-offset-0 col-xs-10 col-xs-offset-1">
