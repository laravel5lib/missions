...
@section('content')
    ...
    @breadcrumbs(['links' => [
        ...
        'admin/campaigns/'.$campaign->id.'/trip-templates/'.$template->id => $template->name,
        'active' => 'Edit'
    ]])
    @endbreadcrumbs
...
<alert-success redirect="/admin/campaigns/{{ $campaign->id }}/trip-templates/{{ $template->id }}">
...
<ajax-form method="put" action="campaigns/{{$campaign->id}}/trip-templates/{{ $template->id }}" :initial="{{ json_encode([
    'name' => $template->name,
    ...
    'closed_at' => optional($template->closed_at)->toDateTimeString(),
...
<div class="container">
    <div class="row">
        <div class="col-xs-12">
            <h3 class="text-primary">Edit Trip Template</h3>
        </div>
    </div>
</div>
...
<div class="container">
    <div class="row">
        <div class="col-xs-12 text-right">
            <a href="{{ url('/admin/campaigns/'.$campaign->id.'/trip-templates/'.$template->id) }}" class="btn btn-link">Cancel</a>
