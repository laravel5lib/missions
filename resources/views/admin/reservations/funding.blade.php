...
<div class="panel panel-body">
    <div class="row">
        ...
        @if($reservation->fund->fundraisers->count())
            <a class="btn btn-block btn-default-hollow" href="/admin/fundraisers/{{ $reservation->fund->fundraisers->first()->uuid }}/edit">Manage Fundraiser</a>
        @else
            <a class="btn btn-block btn-default-hollow" href="/admin/funds/{{ $reservation->fund->id }}/fundraisers/create">Start a Fundraiser</a>
        @endif
        </div>
        <div class="col-sm-6">
