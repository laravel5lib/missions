...
@section('content')
    <div class="white-header-bg">
        <div class="container">
            <div class="row">
                <div class="col-sm-8">
                    <h3 class="hidden-xs">My Influencer Application <small>&middot; Edit</small></h3>
                    <h3 class="visible-xs text-center">My Influencer Application<br><small>Edit</small></h3>
                </div>
