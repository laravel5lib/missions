...
@section('content')
    ...
    <p style="color: #242424;font-family:Helvetica, Arial, sans-serif;"><span style="color:#3e3e3e;font-weight:bold;">{{ $donation->donor->name }}</span> donated <span style="color:#05ce7b;font-weight:bold;">${{ $donation->amountInDollars() }}</span> to <span style="color:#3e3e3e;font-weight:bold;">{{ $donation->fund->name }}</span></p>
