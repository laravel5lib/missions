...
@section('content')
    ...
    <p style="color: #242424;font-family:Helvetica, Arial, sans-serif;text-align:center;"><a href="{{ url('campaigns') }}" style="color:#fff;margin:0;padding:15px 25px;background:#f6323e;display:inline-block;text-decoration:none;border-radius:4px;font-weight:bold;margin-bottom:15px;">Go on a Trip</a>
    </p>
    ...
    <p style="color: #242424;font-family:Helvetica, Arial, sans-serif;text-align:center;"><a href="{{ url('fundraisers') }}" style="color:#fff;margin:0;padding:15px 25px;background:#f6323e;display:inline-block;text-decoration:none;border-radius:4px;font-weight:bold;margin-bottom:15px;">Support a Cause</a>
    </p>
	
    <p style="color: #242424;font-family:Helvetica, Arial, sans-serif;text-align:center;">Make sure your account looks sharp.</p>
    <p style="color: #242424;font-family:Helvetica, Arial, sans-serif;text-align:center;"><a href="{{ url('login') }}" style="color:#fff;margin:0;padding:15px 25px;background:#f6323e;display:inline-block;text-decoration:none;border-radius:4px;font-weight:bold;">Update My Profile</a></p>
@stop
